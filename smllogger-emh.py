...
def main():
    ...
    try:
        ...
        logging.critical("Fehler serielle Schnittstelle: %s", e)
        sys.exit(1)
    ...
    try:
        ...
        logging.critical("Konnte nicht auf Startsequenz synchronisieren")
        sys.exit(1)
    ...
    while True:
        try:
            ...
            reading_ok = False
            logging.warning("Fehler serielle Schnittstelle: %s", e)
        if reading_ok:
...
#                    ("stromzaehler/81726", sml81726),
                ...
                try:
                    ...
                    logging.warning("RRDtool-Fehler: %s", e)
            else:
                logging.warning("CRC-Fehler")
